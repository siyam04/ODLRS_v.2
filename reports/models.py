...
class OrderValidation(models.Model):
    ...
    approved_orders = models.ForeignKey(TestOrder, on_delete=models.DO_NOTHING)
...
#
#     confirmed_orders = models.ForeignKey(OrderValidation, on_delete=models.CASCADE)
#
#     upload_reports = models.FileField(upload_to='report_docs')

    # send_report =
    # report_sending_datetime =
    # report_sent_by_staff = models.BooleanField()

    # class Meta:
    #     ordering = ['-id']
    #
    # def __str__(self):
    #     return self.confirmed_orders.approved_orders.test_info.test_name
